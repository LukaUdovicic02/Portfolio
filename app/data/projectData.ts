...
export const projectData = () => [
  {
    ...
    image: DineEaseBG,
    skills: [".NET C#", "React.js", "RESTful" , "WebAPI", "Entity Framework Core" , "Typescript", "TailwindCSS" , "Scrum" , "Azure Services", "Docker", "JWT" ],
    technologies:[" Intelij", "VSCode", "Docker" , "Astah", "Postman"],
