    ...
    >
      <div
        className="absolute inset-0 bg-[url(/images/backgroundHomePage.png)] 
                   sm:bg-[position:-50px_680px] 2xs:bg-[position:-100px_420px] -z-1 opacity-70 
      ...
      justify-center items-center text-transparent bg-clip-text bg-linear-to-r
       from-orange-900  via-yellow-600 to-orange-900 mt-10 animated-gradient"
        ...
        <p
          className="text-secondarytext sm:text-xl sm:tracking-[0.2em] align-top xs:text-[15px]  2xs:text-[13px]
        2xs:w-full md:w-[764px] sm:h-[246px] text-center mb-16 "
        >
